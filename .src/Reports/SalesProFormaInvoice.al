report 50007 "Pro Forma Invoice"
{
    DefaultLayout = RDLC;
        ...
        dataitem("Sales Invoice Header"; "Sales Header")
        {
            ...
            dataitem("Purchase Line1"; "Sales Line")
            {
                ...
                begin
                    ...
                    TOTALAMT := 0;
                    RecPurchaseLine.RESET;
                    RecPurchaseLine.SETRANGE(RecPurchaseLine."Document Type", "Sales Invoice Header"."Document Type");
                    RecPurchaseLine.SETFILTER(RecPurchaseLine."Document No.", "Sales Invoice Header"."No.");
                    ...
                    RecPurchComLine.SETRANGE(RecPurchComLine."Document Type", "Purchase Line1"."Document Type");
            ...
            begin
                ...
                PurchaseLineTmp.SETRANGE("Document Type", "Sales Invoice Header"."Document Type");
                ...
                Clear(IGSTAmt);
                purchline.RESET;
                purchline.SETRANGE("Document Type", "Sales Invoice Header"."Document Type");
