report 50006 "Sales Quote New"
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Header")
        {
            ...
            column(UserID_PurchaseHeader; '') //23092025
            {
            }
            ...
            dataitem("Purchase Line1"; "Sales Line")
            {
                ...
                begin
                    ...
                    TOTALAMT := 0;
                    RecPurchaseLine.RESET;
                    RecPurchaseLine.SETRANGE(RecPurchaseLine."Document Type", RecPurchaseLine."Document Type"::Quote);
                    RecPurchaseLine.SETFILTER(RecPurchaseLine."Document No.", "Sales Invoice Header"."No.");
                    ...
                    RecPurchComLine.SETRANGE(RecPurchComLine."Document Type", RecPurchComLine."Document Type"::Quote);
                    ...
                    /*   DetailGDTEntryBuffer.RESET;
                       ...
                       DetailGDTEntryBuffer.SETRANGE("Document Type", DetailGDTEntryBuffer."Document Type"::Quote);
            ...
            begin
                ...
                PurchaseLineTmp.SETRANGE("Document Type", PurchaseLineTmp."Document Type"::Quote);
                ...
                InitTextVariable();
                FormatNoText(TotalInvAmtinWords, TotalVal, '');
                TotalInvAmtinWords[1] := LOWERCASE(TotalInvAmtinWords[1]);
                lTxt := COPYSTR(TotalInvAmtinWords[1], 1, 1);
                lTxt := UPPERCASE(lTxt);
