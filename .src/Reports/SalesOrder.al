report 50002 "Sales Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.src\Reports\SalesOrder.rdl';
    ApplicationArea = all;
    // UsageCategory = ReportsAndAnalysis;
    Caption = 'Sales Order Tax';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(ExpectedReceiptDate_PurchaseHeader; "Sales Header"."Promised Delivery Date")
            {
            }
            column(No_PurchaseHeader; "Sales Header"."No.")
            {
            }
            column(OrderDate_PurchaseHeader; "Sales Header"."Order Date")
            {
            }
            column(QuoteNo_PurchaseHeader; "Sales Header"."Quote No.")
            {
            }
            column(BuyfromVendorNo_PurchaseHeader; "Sales Header"."Sell-to Customer No.")
            {
            }
            ...
            column(FrieghtTerms_PurchaseHeader; "Sales Header"."Payment Terms Code" + ' .') //23092025
            {
            }
            column(VendorItemCode; RecVendorItem."Vendor Item No.")
            {
            }
            column(DocumentDate_PurchaseHeader; "Sales Header"."Document Date")
            {
            }
            ...
            column(VendorOrderNo_PurchaseHeader; "Sales Header"."External Document No.")
            {
            }
            column(PaymentTermsCode_PurchaseHeader; "Sales Header"."Payment Terms Code" + ' .')
            {
            }
            column(POValidityDate_PurchaseHeader; "Sales Header"."Posting Date")//23092025
            {
            }
            column(VendorOrderDate_PurchaseHeader; "Sales Header"."Posting Date")//23092025
            {
            }
            ...
            column(PurchaserCode_PurchaseHeader; "Sales Header"."Salesperson Code")
            {
            }
            column(Approvedby_PurchaseHeader; "Sales Header".SystemCreatedBy) //23092025
            {
            }
            column(UserID_PurchaseHeader; "Sales Header"."Assigned User ID") //23092025
            {
            }
            column(PurchaserName; PurchaserName)
            {
            }
            column(Warranty_PurchaseHeader; "Sales Header"."No.")//23092025
            {
            }
            column(Installation_PurchaseHeader; "Sales Header"."No.")//23092025
            {
            }
            column(AmmendmentReason_PurchaseHeader; "Sales Header"."Reason Code")//23092025
            {
            }
            column(Remarks_header; Remarks_header)
            {
            }
            column(OtherTerms_PurchaseHeader; "Sales Header"."No.")//23092025
            {
            }
            column(PurchaseHeader_ApproverID; "Sales Header".SystemCreatedBy)//23092025
            {
            }
            column(Approver_name; Appr_name)
            {
            }
            column(Status_PurchaseHeader; "Sales Header".Status)
            {
            }
            ...
            dataitem("Purchase Line1"; "Sales Line")
            {
                ...
                begin
                    ...
                    /*    CstAmount := 0;
                        ...
                        RecPurchaseLine.SETFILTER(RecPurchaseLine."Document No.", "Sales Header"."No.");
                    ...
                    /*    strordrline.RESET;
                        AmtToVendor := 0;
                        strordrline.RESET;
                        strordrline.SETRANGE(strordrline."Document No.", "Sales Header"."No.");
            ...
            begin
                ...
                // Clear(SGSTAmt); 
                // Clear(IGSTAmt); 
                IF RecVendor.GET("Sales Header"."Sell-to Customer No.") THEN;
                IF RecContact.GET("Sales Header"."Sell-to Contact No.") THEN;
                ...
                /*  RecPurchaser.RESET;
                 RecPurchaser.SETRANGE(RecPurchaser.Code, "Sales Header"."Approver ID");
                 IF RecPurchaser.FINDFIRST THEN
                     Appr_name := "Sales Header"."Approver ID" + '/' + RecPurchaser.Name; */ //23092025
                ...
                RecLocation.SETRANGE(RecLocation.Code, "Sales Header"."Location Code");
                IF RecLocation.FINDFIRST THEN;


                //Here we get Payment Term
                RecPayTerm.RESET;
                RecPayTerm.SETRANGE(RecPayTerm.Code, "Sales Header"."Payment Terms Code");
                ...
                /*      RecStructOrderLine.RESET;
                     RecStructOrderLine.SETFILTER(RecStructOrderLine."Document No.", '%1', "Sales Header"."No.");
                ...
                RsVendor.RESET;
                IF RsVendor.GET("Sales Header"."Sell-to Customer No.") THEN BEGIN
                ...
                PurchaseLineTmp.SETRANGE("Document No.", "Sales Header"."No.");
                ...
                Clear(IGSTAmt);
                purchline.RESET;
                purchline.SETRANGE("Document No.", "Sales Header"."No.");
