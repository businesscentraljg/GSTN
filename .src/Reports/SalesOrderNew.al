        ...
        dataitem("Sales Invoice Header"; "Sales Header")
        {
            ...
            dataitem("Purchase Line1"; "Sales Line")
            {
                ...
                begin
                    ...
                    RecPurchComLine.SETRANGE(RecPurchComLine."Document Type", RecPurchComLine."Document Type"::Order);
            ...
            begin
                ...
                PurchaseLineTmp.SETRANGE("Document Type", PurchaseLineTmp."Document Type"::Order);
