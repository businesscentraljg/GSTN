report 50001 "Purchase Order"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(FrieghtTerms_PurchaseHeader; "Purchase Header"."Payment Terms Code" + ' .') //23092025
            {
            }
            ...
            column(POValidityDate_PurchaseHeader; "Purchase Header"."Posting Date")//23092025
            {
            }
            column(VendorOrderDate_PurchaseHeader; "Purchase Header"."Posting Date")//23092025
            {
            }
            ...
            column(Approvedby_PurchaseHeader; "Purchase Header".SystemCreatedBy) //23092025
            {
            }
            column(UserID_PurchaseHeader; "Purchase Header"."Assigned User ID") //23092025
            {
            }
            column(PurchaserName; PurchaserName)
            {
            }
            column(Warranty_PurchaseHeader; "Purchase Header"."No.")//23092025
            {
            }
            column(Installation_PurchaseHeader; "Purchase Header"."No.")//23092025
            {
            }
            column(AmmendmentReason_PurchaseHeader; "Purchase Header"."Reason Code")//23092025
            {
            }
            column(Remarks_header; Remarks_header)
            {
            }
            column(OtherTerms_PurchaseHeader; "Purchase Header"."No.")//23092025
            {
            }
            column(PurchaseHeader_ApproverID; "Purchase Header".SystemCreatedBy)//23092025
            {
            }
            ...
            dataitem("Purchase Line1"; "Purchase Line")
            {
                ...
                column(DirectUnitCost_PurchaseLine; "Purchase Line1"."Direct Unit Cost")
                {
                }
                ...
                column(VendorItemNo_PurchaseLine; "Purchase Line1"."Vendor Item No.")
                {
                }
                column(ExpectedReceiptDate_PurchaseLine; "Purchase Line1"."Expected Receipt Date")
                {
                }
                ...
                begin
                    ...
                    /*    CstAmount := 0;
                        ...
                        RecPurchaseLine.SETFILTER(RecPurchaseLine."Document No.", "Purchase Header"."No.");
                    ...
                    /*    strordrline.RESET;
                        AmtToVendor := 0;
                        strordrline.RESET;
                        strordrline.SETRANGE(strordrline."Document No.", "Purchase Header"."No.");
            ...
            begin
                ...
                IF RecContact.GET("Purchase Header"."Buy-from Contact No.") THEN;
                ...
                ELSE
                    RecPurchaser.RESET;
                RecPurchaser.SETRANGE(RecPurchaser.Code, "Purchaser Code");
                IF RecPurchaser.FINDFIRST THEN
                    PurchaserName := RecPurchaser.Code + '/' + RecPurchaser.Name;

                /*  RecPurchaser.RESET;
                 RecPurchaser.SETRANGE(RecPurchaser.Code, "Purchase Header"."Approver ID");
                 IF RecPurchaser.FINDFIRST THEN
                     Appr_name := "Purchase Header"."Approver ID" + '/' + RecPurchaser.Name; */ //23092025
                ...
                RecLocation.SETRANGE(RecLocation.Code, "Purchase Header"."Location Code");
                IF RecLocation.FINDFIRST THEN;


                //Here we get Payment Term
                RecPayTerm.RESET;
                RecPayTerm.SETRANGE(RecPayTerm.Code, "Purchase Header"."Payment Terms Code");
                ...
                /*      RecStructOrderLine.RESET;
                     RecStructOrderLine.SETFILTER(RecStructOrderLine."Document No.", '%1', "Purchase Header"."No.");
                ...
                RsVendor.RESET;
                IF RsVendor.GET("Purchase Header"."Buy-from Vendor No.") THEN BEGIN
                    RsVendorPosting.RESET;
                    RsVendorPosting.SETRANGE(RsVendorPosting.Code, RsVendor."Vendor Posting Group");
                    IF RsVendorPosting.FINDFIRST THEN
                        InvoiceRoundingAcc := RsVendorPosting."Invoice Rounding Account";
                END;

                PurchaseLineTmp.RESET;
                PurchaseLineTmp.SETRANGE("Document No.", "Purchase Header"."No.");
    ...
    var
        ...
        RsVendorPosting: Record "Vendor Posting Group";
        PurchaseLineTmp: Record "Purchase Line";
        Charge: Decimal;
        Charge1: Decimal;
        ...
        newCnt: Integer;
        ExcisePer: Decimal;
        "RecPurch&PaySetup": Record "Purchases & Payables Setup";
        TaxCode: Code[30];
        Comment_Remarks: Text;
        RecPurchComLine: Record "Purch. Comment Line";
        RecPurchHeadArchive: Record "Purchase Header Archive";
        AmndNo: Integer;
        VendState: Text;
        CompState: Text;
        ...
        PurchaserName: Text;
        Remarks_header: Text;
        RecPurchComHead: Record "Purch. Comment Line";
